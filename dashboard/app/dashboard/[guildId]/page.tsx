...
export default async function GuildSettingsPage({
  ...
  return (
    <main className="shell page">
      ...
      {query.success ? (
        <div className="feedback-banner success-banner">Saved: {query.success.replace(/-/g, " ")}</div>
      ) : null}
      {query.error ? (
        <div className="feedback-banner error-banner">Error: {query.error.replace(/-/g, " ")}</div>
      ) : null}
          ...
          <div className="detail-list">
            ...
            <div>
              ...
              <span className="muted">
                NOVA creates a guild row, guild settings, and all built-in commands the first time
                this page is opened.
              </span>
            </div>
            <div>
              ...
              <span className="muted">
                AUTO follows eligible speakers automatically. MANUAL keeps the setting ready for a
                future explicit join workflow.
              </span>
            </div>
          </div>
              ...
              {config.allowedSpeakers.map((allowedSpeaker) => (
                <div key={allowedSpeaker.id} className="config-row">
                  ...
                  <form action={deleteAllowedSpeakerAction} className="inline-form">
                    <input type="hidden" name="guildId" value={guildId} />
                    <input type="hidden" name="allowedSpeakerId" value={allowedSpeaker.id} />
                    <button className="button secondary" type="submit">
                      Delete
                    </button>
                  </form>
